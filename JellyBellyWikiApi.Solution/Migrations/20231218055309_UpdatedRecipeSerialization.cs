...
{
    public partial class UpdatedRecipeSerialization : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyColumn: "RecipeId",
                keyValue: 1,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"GLAZE, 2 cups icing sugar, 1/4 cup milk, approx., 1 tsp vanilla extract, 1/2 cup Jelly Belly Valentine Mix:, Bubble Gum, Coconut, Cotton Candy, Strawberry Cheesecake and Very Cherry\"]", "[\"\"]", "[\"\"]", "[\"Preheat oven to 375\\u00B0F. Grease one standard donut pan well with butter or cooking spray., In a large bowl, sift together flour, sugar, baking powder, baking soda and salt., In separate bowl, whisk together buttermilk, egg, melted butter and vanilla., Stir the dry ingredients into the liquid ingredients until combined., Spoon the batter into the pan, filling each mold three-quarters full., Bake for 9 to 10 minutes or until tops spring back when pressed and a toothpick inserted into the donuts comes out clean., Let cool in pan for 5 minutes. Remove from pan and cool on rack. Reinforce donut holes with handle of wooden spoon, if necessary., Glaze: In a small bowl, whisk together icing sugar and milk, adding more milk a teaspoon at a time until icing is thin enough for donuts to be dipped into., Dip donuts into glaze, turning to coat top completely. Return to rack to set. Dip a second time to create a solid white finish. Arrange Jelly Belly\\u00AE jelly beans on top, sprinkling or placing as you wish.\"]", "[\"3/4 cup all-purpose flour, 1/2 cup granulated sugar, 3/4 tsp baking powder, 1/4 tsp baking soda, 1/4 tsp salt, 1/3 cup buttermilk, 1 egg, 1/4 cup melted unsalted butter, 1/2 tsp vanilla extract\"]", "[\"Tint icing sugar with red food coloring for a red or pink finish.\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 15,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"DECORATION: 3 to 4 drops green food coloring, 3/4 cup prepared white frosting, 1 cup Jelly Belly\\u00AE jelly beans\"]", "[\"ASSEMBLY: Using parchment paper as handles, remove brownies from pan and transfer to cutting board. Peel off parchment paper. Cut into Christmas tree shapes by first cutting into 3 rows. Then cut each row into 5 triangles, reserving any smaller pieces for another use., Stir food coloring into frosting until blended; spoon into small resealable plastic bag (snip corner of bag) or pastry bag with tip., Squeeze bag to pipe frosting over brownies to resemble garland., Decorate with Jelly Belly jelly beans as Christmas lights and insert a pretzel stick into bottom of triangle as the tree trunk. Cover and store in airtight container for up to 2 days.\"]", "[\"\"]", "[\"Preheat oven to 350\\u00B0F. Grease 9-inch square pan with butter. Line bottom and sides with parchment paper, leaving 2-inch overhang; set aside., Place chocolate and butter in heatproof bowl set over barely simmering water; heat, stirring occasionally, until melted and smooth. Remove from heat and stir in sugar. Let cool slightly. Whisk together flour, cocoa, baking powder and salt; set aside., Stir eggs into chocolate mixture, one at a time, until well combined. Stir in vanilla, then stir in flour mixture until combined. Scrape into prepared pan; smooth top., Bake for 20 to 25 minutes or until only a few moist crumbs cling to toothpick when inserted in center. Let cool completely in pan on rack.\"]", "[\"BROWNIES: 8 oz dark chocolate, finely chopped, 3/4 cup unsalted butter, cubed, 1 cup granulated sugar, 1/2 cup all-purpose flour, 3 tbsp cocoa powder, 1/2 tsp baking powder, 1/2 tsp salt, 3 eggs, at room temperature, 1 tsp vanilla\"]", "[\"Use leftover brownie pieces to make brownie and jelly bean ice cream sundaes.\",\"Make brownies ahead and freeze in airtight container for up to 1 month.\",\"For a quick alternative, use prepared brownie mix and ready-to-use colored icing in tubes.\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 16,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"\"]", "[\"\"]", "[\"\"]", "[\"Make the cake mix as directed on the box. Cool completely and then crumble the cake., Add a small amount of premade frosting to the crumbled cake, roll into small balls, and chill to form the cake pop., Fill the mini ice cream cones with Jelly Belly jelly beans. Fill until the jelly beans are just below the rim of the cone., Melt the candy melts., Dip the cake pop into the melted chocolate until the bottom of the cake pop is fully covered. Place the cake pop on top of the cone and let it set., Once the cake pop has dried onto the cone, hold the cone at the base and dip the rest of the cake pop into the melted chocolate. Cover the cake pop completely and let it set., Optional: Drizzle additional chocolate on top of the cake pop and place more Jelly Belly jelly beans in the melted chocolate as a topping., Enjoy!\"]", "[\"Mini ice cream cones, Cake mix, Premade frosting, Candy melts, Jelly Belly Christmas Mix\"]", "[\"\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 17,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"\"]", "[\"\"]", "[\"\"]", "[\"Cut your ribbon to the desired length. Use hot glue to attach the ribbon to the foam wreath form. This will be used to hang the wreath once it is complete., Sort the jelly beans into piles by color and decide on the design or pattern you would like to use for your wreath., Apply the jelly beans to the foam wreath form using the edible glue. Apply jelly beans to the front, inside, and outside of the wreath form but it is recommended to leave the back bare so the wreath can hang flat., Once the glue has dried, hang your wreath and enjoy your sweet new d\\u00E9cor!\"]", "[\"Foam wreath form, Scissors, Ribbon, Edible glue, Jelly Belly jelly beans\"]", "[\"\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 18,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"\"]", "[\"\"]", "[\"\"]", "[\"Bake cupcakes according to package and let fully cool., Fill a piping bag with white frosting and snip a hole in the tip., Pipe a white frosting ring on top of the cupcake., Add a waffle cone on top of frosted cupcake., Fill a piping bag with green frosting, then snip a small triangle at the tip., Carefully pipe green frosting around the outside of cone to make a Christmas tree., Add Jelly Belly 49 Flavors jelly beans to resemble Christmas lights as desired., Top with a decorative star., Enjoy!\"]", "[\"Box cake mix, 1 container of green prepackaged frosting, 1 container of white prepackaged frosting, 12 waffle cones, 2 piping bags, Jelly Belly 49-Flavor Mix Jelly Beans\"]", "[\"\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 19,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"Decorative ribbon\"]", "[\"\"]", "[\"\"]", "[\"Remove the top from the jar, Scoop in Jelly Belly jelly beans until the bottom of the jar is completely covered leaving enough room for the height of your chosen d\\u00E9cor items., Arrange your decorative items on top of the jelly beans., Place the lid back on the jar and finish with a decorate ribbon.\"]", "[\"Jar or container with removable lid, Small Christmas decorative items, Jelly Belly French Vanilla jelly beans or Jelly Belly coconut jelly beans\"]", "[\"\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 20,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"\"]", "[\"\"]", "[\"\"]", "[\"Add rolled oats, pretzels, popcorn, sprinkles, and jelly beans into a large bowl., Drizzle melted white chocolate on top of mixture and stir until the chocolate coats the ingredients., Spread out the chocolate-covered mixture onto a baking pan and allow it to set., Once it has dried, add additional jelly beans to the top., Break the mixture apart into smaller pieces., Place the smaller pieces into a jar or container for a sweet gift or snack on Christmas Day!\"]", "[\"Rolled oats, Pretzels, Popcorn, White chocolate, Sprinkles (optional), Jelly Belly Christmas Mix\"]", "[\"\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 24,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"\"]", "[\"\"]", "[\"\"]", "[\"Tint the vanilla frosting with 3 to 4 drops of the yellow food coloring and the cocoa powder to make a light brown for the piecrust. Spread some of the frosting on top of a cupcake, leaving the \\u00BC inch of the cupcake edge exposed. For the filling, arrange about 25 like-colored jelly beans close together on top of the cupcake. Repeat with the remaining cupcakes and like-colored jelly beans., Spoon the remaining light brown frosting into a ziplock bag, press out the excess air, and seal. Snip a small (\\u215B inch) corner from the bag. For the lattice rust, pipe 4 or 5 lines across the top of a cupcake, about \\u00BD inch apart. Pipe 4 or 5 more lines, on the diagonal. Pipe a beaded edge around top of cupcake. Repeat with the remaining cupcakes and frosting., Arrange the cupcakes on a wire rack and make bake-sale tags to display the cupcakes.\"]", "[\"24 vanilla cupcakes baked in silver foil liners, 2 cans (16 oz each) vanilla frosting, Yellow food coloring, 1 teaspoon unsweetened cocoa powder, 1 cup each (about 8 oz) Very Cherry and Blueberry Jelly Belly jelly beans\"]", "[\"\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 25,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"\"]", "[\"\"]", "[\"\"]", "[\"In a small bowl, combine sugar and cinnamon. In a large bowl, combine popcorn, cereal, and cranberries., Spray popcorn mixture lightly for 4 to 5 seconds with cooking spray; quickly toss with sugar mixture. Stir in Jelly Belly beans and pretzels. Store in covered container., Stir well before serving. For a fun hostess gift, spoon into clear container and finish with a pretty ribbon.\"]", "[\"1 tablespoon sugar, 1 tablespoon ground cinnamon, 2 cups prepared air-popped popcorn, 1 cup bite-size crispy wheat squares, \\u00BD cup dried cranberries, cherries or raisins, 2 \\u00BD cups assorted Jelly Belly jelly beans, 2 cups fat-free mini pretzels, Nonstick cooking spray, butter flavor\"]", "[\"\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 26,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"\"]", "[\"\"]", "[\"\"]", "[\"Pre-bake butterfly sugar cookies in advance., Set up a decorating station for guests with bowls of frosting and assorted Jelly Belly jelly beans in the listed flavors., Invite guests to decorate their own butterfly cookies using the frosting and jelly beans.\"]", "[\"Butterfly-shaped sugar cookies, Frosting, Jelly Belly jelly beans in the following flavors: Champagne, Cotton Candy, 7UP\\u00AE, Sunkist\\u00AE Orange, Ginger Ale, Jewel Grape Soda, Jewel Blueberry, Jewel Berry Blue, Jewel Cream Soda, Jewel Bubble Gum\"]", "[\"\"]" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 27,
                columns: new[] { "Additions1Json", "Additions2Json", "Additions3Json", "DirectionsJson", "IngredientsJson", "TipsJson" },
                values: new object[] { "[\"\"]", "[\"\"]", "[\"\"]", "[\"Pre-order or prepare a frosted round cake., Arrange the Jelly Belly jelly beans around the sides and top of the cake, creating an ombr\\u00E9 effect by gradually transitioning from one color/flavor to the next.\"]", "[\"Pre-frosted round cake, Jelly Belly jelly beans in the following flavors: Sunkist\\u00AE Pink Grapefruit, Jewel Orange, Sunkist\\u00AE Tangerine, Sunkist\\u00AE Orange, Orange Sherbet, Jewel Very Cherry, Cotton Candy, Strawberry Cheesecake, Bubble Gum, Jewel Bubble Gum\"]", "[\"\"]" });
        }
