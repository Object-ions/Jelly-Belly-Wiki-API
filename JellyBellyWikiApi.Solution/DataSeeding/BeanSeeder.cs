    ...
    public static void Seed(ModelBuilder builder)
    {
      builder.Entity<Bean>().HasData(
        ...
        { 
          ...
          Ingredients = new string[] { "Sugar", "Corn Syrup", "Modified Food Starch", "Contains 2% or less of the following: Natural and Artificial Flavors, Color Added, Vegetable and Fruit Juice (Color), Beeswax, Carnauba Wax, Confectioner's Glaze."},
          ColorGroup = "White",
        ...
        new Bean
        {
          ...
          Ingredients = new string[] { "Sugar", "Corn Syrup", "Modified Food Starch", "Contains 2% or less of the following: Citric Acid, Natural and Artificial Flavor, Color Added, Blue 1, Beeswax, Carnauba Wax, Confectioner's Glaze."},
          ColorGroup = "Blue",
          GlutenFree = false,
          SugarFree = false,
          Seasonal = false,
        ...
        new Bean
        {
          ...
          Ingredients = new string[] { "Sugar", "Corn Syrup", "Modified Food Starch", "Blueberry Juice From Puree", "Contains 2% or less of the following: Citric Acid, Natural and Artificial Flavor, Color Added, Blue 1 Lake, Beeswax, Carnauba Wax, Confectioner's Glaze."},
          ColorGroup = "Blue",
          GlutenFree = false,
          SugarFree = false,
          Seasonal = false,
        ...
        new Bean
        {
          ...
          Description = " ",
          Ingredients = new string[] { "Sugar", "Corn Syrup", "Modified Food Starch", "Contains 2% or less of the following: Artificial Flavor, Color Added, Red 40 Lake, Red 40, Yellow 5 Lake, Beeswax, Carnauba Wax, Confectioner's Glaze."},
          ColorGroup = "Pink",
          GlutenFree = false,
          SugarFree = false,
          Seasonal = false,
