    ...
    public static void Seed(ModelBuilder builder)
    {
      builder.Entity<Recipe>().HasData(
        ...
        new Recipe
        {
          ...
          Ingredients = new[] { "Mini ice cream cones, Cake mix, Premade frosting, Candy melts, Jelly Belly Christmas Mix" },
          Additions1 = new[] {""},
          Additions2 = new[] {""},
          Additions3 = new[] {""},
          Directions = new[] { "Make the cake mix as directed on the box. Cool completely and then crumble the cake., Add a small amount of premade frosting to the crumbled cake, roll into small balls, and chill to form the cake pop., Fill the mini ice cream cones with Jelly Belly jelly beans. Fill until the jelly beans are just below the rim of the cone., Melt the candy melts., Dip the cake pop into the melted chocolate until the bottom of the cake pop is fully covered. Place the cake pop on top of the cone and let it set., Once the cake pop has dried onto the cone, hold the cone at the base and dip the rest of the cake pop into the melted chocolate. Cover the cake pop completely and let it set., Optional: Drizzle additional chocolate on top of the cake pop and place more Jelly Belly jelly beans in the melted chocolate as a topping., Enjoy!" },
          Tips = new[] {""},
        },
        new Recipe
        {
          ...
          Ingredients = new[] { "Foam wreath form, Scissors, Ribbon, Edible glue, Jelly Belly jelly beans" },
          Additions1 = new[] {""},
          Additions2 = new[] {""},
          Additions3 = new[] {""},
          Directions = new[] { "Cut your ribbon to the desired length. Use hot glue to attach the ribbon to the foam wreath form. This will be used to hang the wreath once it is complete., Sort the jelly beans into piles by color and decide on the design or pattern you would like to use for your wreath., Apply the jelly beans to the foam wreath form using the edible glue. Apply jelly beans to the front, inside, and outside of the wreath form but it is recommended to leave the back bare so the wreath can hang flat., Once the glue has dried, hang your wreath and enjoy your sweet new décor!" },
          Tips = new[] {""},
        },
        new Recipe
        {
          ...
          Ingredients = new[] { "Box cake mix, 1 container of green prepackaged frosting, 1 container of white prepackaged frosting, 12 waffle cones, 2 piping bags, Jelly Belly 49-Flavor Mix Jelly Beans" },
          Additions1 = new[] {""},
          Additions2 = new[] {""},
          Additions3 = new[] {""},
          Directions = new[] { "Bake cupcakes according to package and let fully cool., Fill a piping bag with white frosting and snip a hole in the tip., Pipe a white frosting ring on top of the cupcake., Add a waffle cone on top of frosted cupcake., Fill a piping bag with green frosting, then snip a small triangle at the tip., Carefully pipe green frosting around the outside of cone to make a Christmas tree., Add Jelly Belly 49 Flavors jelly beans to resemble Christmas lights as desired., Top with a decorative star., Enjoy!" },
          Tips = new[] {""},
        },
        new Recipe
        {
          ...
          Ingredients = new[] { "Jar or container with removable lid, Small Christmas decorative items, Jelly Belly French Vanilla jelly beans or Jelly Belly coconut jelly beans" },
          Additions1 = new[] {"Decorative ribbon"},
          Additions2 = new[] {""},
          Additions3 = new[] {""},
          Directions = new[] { "Remove the top from the jar, Scoop in Jelly Belly jelly beans until the bottom of the jar is completely covered leaving enough room for the height of your chosen décor items., Arrange your decorative items on top of the jelly beans., Place the lid back on the jar and finish with a decorate ribbon." },
          Tips = new[] {""},
        },
        new Recipe
        {
        ...
        new Recipe
        {
          ...
          Ingredients = new[] { "24 vanilla cupcakes baked in silver foil liners, 2 cans (16 oz each) vanilla frosting, Yellow food coloring, 1 teaspoon unsweetened cocoa powder, 1 cup each (about 8 oz) Very Cherry and Blueberry Jelly Belly jelly beans" },
          Additions1 = new[] {""},
          Additions2 = new[] {""},
          Additions3 = new[] {""},
          Directions = new[] { "Tint the vanilla frosting with 3 to 4 drops of the yellow food coloring and the cocoa powder to make a light brown for the piecrust. Spread some of the frosting on top of a cupcake, leaving the ¼ inch of the cupcake edge exposed. For the filling, arrange about 25 like-colored jelly beans close together on top of the cupcake. Repeat with the remaining cupcakes and like-colored jelly beans., Spoon the remaining light brown frosting into a ziplock bag, press out the excess air, and seal. Snip a small (⅛ inch) corner from the bag. For the lattice rust, pipe 4 or 5 lines across the top of a cupcake, about ½ inch apart. Pipe 4 or 5 more lines, on the diagonal. Pipe a beaded edge around top of cupcake. Repeat with the remaining cupcakes and frosting., Arrange the cupcakes on a wire rack and make bake-sale tags to display the cupcakes." },
          Tips = new[] {""},
        },
        ...
        new Recipe
        {
          ...
          Ingredients = new[] { "1 tablespoon sugar, 1 tablespoon ground cinnamon, 2 cups prepared air-popped popcorn, 1 cup bite-size crispy wheat squares, ½ cup dried cranberries, cherries or raisins, 2 ½ cups assorted Jelly Belly jelly beans, 2 cups fat-free mini pretzels, Nonstick cooking spray, butter flavor" },
          Additions1 = new[] {""},
          Additions2 = new[] {""},
          Additions3 = new[] {""},
          Directions = new[] { "In a small bowl, combine sugar and cinnamon. In a large bowl, combine popcorn, cereal, and cranberries., Spray popcorn mixture lightly for 4 to 5 seconds with cooking spray; quickly toss with sugar mixture. Stir in Jelly Belly beans and pretzels. Store in covered container., Stir well before serving. For a fun hostess gift, spoon into clear container and finish with a pretty ribbon." },
          Tips = new[] {""},
        },
        new Recipe
        {
          ...
          Ingredients = new[] { "Butterfly-shaped sugar cookies, Frosting, Jelly Belly jelly beans in the following flavors: Champagne, Cotton Candy, 7UP®, Sunkist® Orange, Ginger Ale, Jewel Grape Soda, Jewel Blueberry, Jewel Berry Blue, Jewel Cream Soda, Jewel Bubble Gum" },
          Additions1 = new[] {""},
          Additions2 = new[] {""},
          Additions3 = new[] {""},
          Directions = new[] { "Pre-bake butterfly sugar cookies in advance., Set up a decorating station for guests with bowls of frosting and assorted Jelly Belly jelly beans in the listed flavors., Invite guests to decorate their own butterfly cookies using the frosting and jelly beans." },
          Tips = new[] {""},
      },
      new Recipe
      {
        ...
        Ingredients = new[] { "Pre-frosted round cake, Jelly Belly jelly beans in the following flavors: Sunkist® Pink Grapefruit, Jewel Orange, Sunkist® Tangerine, Sunkist® Orange, Orange Sherbet, Jewel Very Cherry, Cotton Candy, Strawberry Cheesecake, Bubble Gum, Jewel Bubble Gum" },
        Additions1 = new[] {""},
        Additions2 = new[] {""},
        Additions3 = new[] {""},
        Directions = new[] { "Pre-order or prepare a frosted round cake., Arrange the Jelly Belly jelly beans around the sides and top of the cake, creating an ombré effect by gradually transitioning from one color/flavor to the next." },
        Tips = new[] {""},
      }
      );
    }
